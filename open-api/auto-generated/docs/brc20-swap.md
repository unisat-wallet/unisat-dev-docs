...
- [brc20-swap](#brc20-swap)
  - [Swap's global configuration information.](#swaps-global-configuration-information)
  - [Gets the balance for the specified address and tick.](#gets-the-balance-for-the-specified-address-and-tick)
  - [Get Pool information based on trade pair.](#get-pool-information-based-on-trade-pair)
  - [Select the tick information that you can use based on the address.](#select-the-tick-information-that-you-can-use-based-on-the-address)
  - [Prepare deploy pool operation](#prepare-deploy-pool-operation)
  - [Deploy the pool operation.](#deploy-the-pool-operation)
  - [Prepare add liquidity operation](#prepare-add-liquidity-operation)
  - [Add the liquidity operation](#add-the-liquidity-operation)
  - [Prepare remove liquidity operation](#prepare-remove-liquidity-operation)
  - [Remove the liquidity operation](#remove-the-liquidity-operation)
  - [Prepare send operation](#prepare-send-operation)
  - [Prepare batch send operation](#prepare-batch-send-operation)
  - [Prepare swap operation](#prepare-swap-operation)
  - [The send operation.](#the-send-operation)
  - [The batch send operation.](#the-batch-send-operation)
  - [The swap operation.](#the-swap-operation)
  - [Gets the pool list information.](#gets-the-pool-list-information)
  - [Gets the user's pool list information.](#gets-the-users-pool-list-information)
  - [Gets the user pool information for the specified pair.](#gets-the-user-pool-information-for-the-specified-pair)
  - [An overview of swap information](#an-overview-of-swap-information)
  - [Gets the gas consumption records for a user aggregation operation.](#gets-the-gas-consumption-records-for-a-user-aggregation-operation)
  - [Gets the history of send transaction.](#gets-the-history-of-send-transaction)
  - [Gets the history of a pair addition pool.](#gets-the-history-of-a-pair-addition-pool)
  - [Gets the history of swap.](#gets-the-history-of-swap)
  - [Get chain history of rollup inscription.](#get-chain-history-of-rollup-inscription)
  - [Gets the deposit list for a user.](#gets-the-deposit-list-for-a-user)
  - [Create a deposit psbt to be signed by the user.](#create-a-deposit-psbt-to-be-signed-by-the-user)
  - [User signature deposit psbt, submit confirmation.](#user-signature-deposit-psbt-submit-confirmation)
  - [Gets the current system state.](#gets-the-current-system-state)
  - [Gets the user withdrawal history.](#gets-the-user-withdrawal-history)
  - [Retry create a withdraw psbt to be signed by the user.](#retry-create-a-withdraw-psbt-to-be-signed-by-the-user)
  - [User signature withdraw psbt, submit confirmation.](#user-signature-withdraw-psbt-submit-confirmation)
  - [Create a withdraw psbt to be signed by the user.](#create-a-withdraw-psbt-to-be-signed-by-the-user)
  - [User signature withdraw psbt, submit confirmation.](#user-signature-withdraw-psbt-submit-confirmation)
  - [Gets the withdrawal progress for the specified ID.](#gets-the-withdrawal-progress-for-the-specified-id)
